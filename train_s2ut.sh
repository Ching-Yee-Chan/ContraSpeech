...
MODEL_DIR=/home/zhaojiankun/zhaojiankun_space/TranSpeech/output_test/s2ut_lm_ckpt
...
CUDA_VISIBLE_DEVICES=4,5,6,7 PYTHONPATH=. fairseq-train $DATA_ROOT \
  ...
  --lr 0.0005 --lr-scheduler inverse_sqrt --warmup-init-lr 1e-7 --warmup-updates 4000 \
